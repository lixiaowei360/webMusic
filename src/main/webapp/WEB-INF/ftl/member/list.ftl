						...
						<#if page?exists && page.list?size gt 0 >
							<#list page.list as it>
								<tr>
									...
									<td>
										<a href="${basePath}/member/getUserInfo.shtml?uuserId=${it.id}">查看用户</a>
										<a href="${basePath}/member/attentionUserInfo.shtml?userId=${it.id}&type=1">查看粉丝</a>
										<a href="${basePath}/member/attentionUserInfo.shtml?userId=${it.id}&type=0">查看关注</a>
