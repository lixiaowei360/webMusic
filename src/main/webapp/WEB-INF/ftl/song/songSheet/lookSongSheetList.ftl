							...
							<#list page.list as it>
								<tr>
									...
									<td>
											...
											<#if type == 'edit'>
												   <a href="${basePath}/songSheetCtrl/deleteSongSheetList.shtml?songSheetId=${songSheet.songSheetId!}&songListId=${it.songListId!}">从歌单中移除</a>
												<#else> 
												   <a href="${basePath}/songSheetCtrl/addSongToSongSheetList.shtml?songSheetId=${songSheet.songSheetId!}&songListId=${it.songListId!}">添加到歌单</a>
											</#if>
