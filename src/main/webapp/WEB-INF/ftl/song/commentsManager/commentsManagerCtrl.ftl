			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<table class="table table-bordered" style="table-layout:fixed" >
							...
							<#list page.list as it>
								<tr>
									...
									<td>
										...
										<i class="glyphicon glyphicon-info-sign"></i><a href="${basePath}/songCommentCtrl/lookCommentsTalk.shtml?topicId=${it.commentsId}">查看对话</a>
						...
						<#else>
							<tr>
								<td class="text-center danger" colspan="8">没有找到任何歌曲</td>
							</tr>
						</#if>
					</table>
					<#if page?exists>
