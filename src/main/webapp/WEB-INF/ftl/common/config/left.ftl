...
<#macro songManager index>
	<#--不需要权限-->
	<div id="one" class="col-md-2">
	<ul data-spy="affix" class="nav nav-list nav-tabs nav-stacked bs-docs-sidenav dropdown affix" style="top: 100px; z-index: 100;">
		 <li class="${(index==1)?string('active',' ')}">
		      <a href="${basePath}/songClassify/songClassifyList.shtml">
		    	 <i class="glyphicon glyphicon-chevron-right"></i>歌曲分类
		      </a>
		 </li>
		 
		 <li class="${(index==2)?string('active',' ')}">
		      <a href="${basePath}/songOperation/songList.shtml">
		    	 <i class="glyphicon glyphicon-chevron-right"></i>歌曲列表
		      </a>
		 </li>
		 
		 <li class="${(index==3)?string('active',' ')}">
		      <a href="${basePath}/songSheetCtrl/songSheetList.shtml">
		    	 <i class="glyphicon glyphicon-chevron-right"></i>歌单列表
		      </a>
		 </li>
	</ul>
	</div>
</#macro>
<#macro comments index>
<div id="one" class="col-md-2">
	<ul data-spy="affix" class="nav nav-list nav-tabs nav-stacked bs-docs-sidenav dropdown affix" style="top: 100px; z-index: 100;">
		 <li class="${(index==1)?string('active',' ')}">
		     <a href="${basePath}/songCommentCtrl/CommentList.shtml?pagesize=1">
		    	 <i class="glyphicon glyphicon-chevron-right"></i>评论管理
		      </a>
		 </li>
	</ul>
</div>
</#macro>
<#macro carousel index>
<div id="one" class="col-md-2">
	<ul data-spy="affix" class="nav nav-list nav-tabs nav-stacked bs-docs-sidenav dropdown affix" style="top: 100px; z-index: 100;">
		 <li class="${(index==1)?string('active',' ')}">
		     <a href="${basePath}/carouselContentCtrl/carouselContentList.shtml?pagesize=1">
		    	 <i class="glyphicon glyphicon-chevron-right"></i>轮播管理
		      </a>
		 </li>
	</ul>
</div>
