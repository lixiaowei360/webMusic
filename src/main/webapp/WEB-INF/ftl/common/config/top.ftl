	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<@shiro.hasAnyRoles name='888888,100003'>
					...
					<li class="dropdown ${(index==4)?string('active','')}">
						<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/permission/index.shtml">
							歌曲管理<span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
								<li><a href="${basePath}/songClassify/songClassifyList.shtml?pagesize=1">歌曲分类</a></li>
								<li><a href="${basePath}/songOperation/songList.shtml?pagesize=1">歌曲列表</a></li>
								<li><a href="${basePath}/songSheetCtrl/songSheetList.shtml?pagesize=1">歌单列表</a></li>
						</ul>
					</li>	
					...
					<li class="dropdown ${(index==5)?string('active','')}">
						...
						<ul class="dropdown-menu">
								<li><a href="${basePath}/songCommentCtrl/CommentList.shtml?pagesize=1">评论管理</a></li>
						</ul>
					</li> 
					
					<li class="dropdown ${(index==6)?string('active','')}">
						<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/permission/index.shtml">
							前台管理<span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
								<li><a href="${basePath}/carouselContentCtrl/carouselContentList.shtml?pagesize=1">轮播管理</a></li>
						</ul>
					</li> 
	          </ul>
