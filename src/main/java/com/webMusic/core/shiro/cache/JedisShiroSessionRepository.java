package com.webMusic.core.shiro.cache;
...
import com.webMusic.common.utils.SerializeUtil;
import com.webMusic.core.shiro.session.CustomSessionManager;
import com.webMusic.core.shiro.session.SessionStatus;
import com.webMusic.core.shiro.session.ShiroSessionRepository;
/**
 * Session 管理
 * @author sojson.com
 *
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    ...
    private static final int SESSION_VAL_TIME_SPAN = 10;
    ...
    public void saveSession(Session session) {
        ...
        try {
            ...
            Long expireTime = sessionTimeOut + SESSION_VAL_TIME_SPAN ;
