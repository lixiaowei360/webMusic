...
import com.webMusic.common.utils.DateUtil;
import com.webMusic.core.config.IConfig;
...
public interface Constant {
	...
	//返回result状态key
	final static String result_success = "sucess";
	final static String result_fail = "fail";
	
	//评论的状态
	final static String commenttypeSong = "0";//歌曲评论
	final static String commenttypeSongSheet = "1";//歌单评论

	public static String CommentToUserType = "0";//回复用户信息
	public static String CommentToSongType = "1";//回复歌曲
	public static String CommentToSongSheetType = "2";//回复歌单

	public static String AddSongListCollectionT = "add";//回复歌单
	public static String RemoveSongListCollectionT = "remove";//回复歌单

	public static String ok = "ok";//确认成功
